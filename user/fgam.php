...
$result=ins_record("fullsangambid","null,'$userid','$username','$email','$city','Open','$full','$closepatti','$openpatti','$amount','$date','$time'");

$result=ins_record("fullsangambidfull","null,'$userid','$username','$email','$city','Open','$full','$closepatti','$openpatti','$amount','$date','$time'");
...
$result=ins_record("fullsangambid","null,'$userid','$username','$email','$city','Close','$full','$closepatti','$openpatti','$amount','$date','$time'");

$result=ins_record("fullsangambidfull","null,'$userid','$username','$email','$city','Close','$full','$closepatti','$openpatti','$amount','$date','$time'");
$result=ins_record("point2","null,'$userid','$username','Dedit','User Bid','$amount','$date','$time'");
$query="update point set  point=point-'$amount' where username='$user'";
  $rst=mysqli_query($con,$query) or die( mysqli_error($con));
//$result23=ins_record("bonus","null,'$username','$email','20','$date'");
  ...
  @media screen and (max-width: 599px) and (min-width: 0px)
{
    ...
    <li class="active"><a data-toggle="pill" href="#home">Full Sangam</a></li>
...
<label for="inputclosepatti" id="na">Close Patti</label>
<input type="text" class="form-control" name="closepatti" id="inputclosepatti" placeholder="Close Patti">
</div>
<div class="form-group col-md-3">
<label for="inputopenpatti" id="na">Open Patti</label>
<input type="text" class="form-control" name="openpatti" id="inputopenpatti" placeholder="Open Patti">
</div>
<div class="form-group col-md-3">
