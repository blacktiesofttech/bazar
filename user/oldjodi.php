...
$result=ins_record("jodibid","null,'$userid','$username','$email','$city','Open','$Jodi','$bidnumber','$point1','$date','$time'");
...
{
if ($cityname==$city." "."Open") {
$result=ins_record("jodibid","null,'$userid','$username','$email','$city','Open','$Jodi','$bidnumber1','$point2','$date','$time'");
...
$result=ins_record("jodibid","null,'$userid','$username','$email','$city','Open','$Jodi','$bidnumber2','$point3','$date','$time'");
...
$result=ins_record("jodibid","null,'$userid','$username','$email','$city','Open','$Jodi','$bidnumber3','$point4','$date','$time'");
...
$result=ins_record("jodibid","null,'$userid','$username','$email','$city','Open','$Jodi','$bidnumber4','$point5','$date','$time'");
...
$result=ins_record("jodibid","null,'$userid','$username','$email','$city','Open','$Jodi','$bidnumber5','$point6','$date','$time'");
...
$result=ins_record("jodibid","null,'$userid','$username','$email','$city','Open','$Jodi','$bidnumber6','$point7','$date','$time'");
...
$result=ins_record("jodibid","null,'$userid','$username','$email','$city','Open','$Jodi','$bidnumber7','$point8','$date','$time'");
...
$result=ins_record("jodibid","null,'$userid','$username','$email','$city','Open','$Jodi','$bidnumber8','$point9','$date','$time'");
...
$result=ins_record("jodibid","null,'$userid','$username','$email','$city','Open','$Jodi','$bidnumber9','$point10','$date','$time'");
  ...
  @media screen and (max-width: 599px) and (min-width: 0px)
{
    ...
    <li class="active"><a data-toggle="pill" href="#home">Jodi</a></li>
...
$(document).ready(function(){
  ...
  $('#ibtn').click(function(){
    i ++;
    $('#naaa').append('<label for="inputjodi" id="na">Jodi No.</label><input type="text" class="form-control" id="itex'+i+'" placeholder="Type Jodi" style="margin-bottom: 10px;" name="ham'+i+'">');
...
<input type="text" class="form-control new" id="itext" name="ha[]" placeholder="Type Bidding Amount" style="margin-bottom: 10px;" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
</div>
<div class="form-group col-md-6 " id="naaa" style="">
<label for="inputjodi" id="na">Jodi No.</label>
...
<div class="form-group col-md-6 " id="naaa" style="">
<label for="inputjodi" id="na">Jodi No.</label>
<input type="text" class="form-control" id="itex" name="ham4" placeholder="Type Jodi" style="margin-bottom: 10px;" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
</div>
<div class="form-group col-md-6" id="naaaa">
<label for="inputjodiamount" id="na">Bid Amount</label>
<input type="text" class="form-control new" id="itext" name="ha[]" placeholder="Type Bidding Amount" style="margin-bottom: 10px;" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
...
<div class="form-group col-md-6 " id="naaa" style="">
<label for="inputjodi" id="na">Jodi No.</label>
<input type="text" class="form-control" id="itex" name="ham5" placeholder="Type Jodi" style="margin-bottom: 10px;" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
</div>
<div class="form-group col-md-6" id="naaaa">
<label for="inputjodiamount" id="na">Bid Amount</label>
<input type="text" class="form-control new" id="itext" name="ha[]" placeholder="Type Bidding Amount" style="margin-bottom: 10px;" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
...
<div class="row ">
  ...
  <div class="panel panel-primary " id="di">
  <div class="panel-heading" id="di1">
  <h3 style="text-align:center;"><?php echo $row['cityname'];?></h3>
  </div>
  <div class="panel-footer" id="di2"><h3 style="text-align:center;">Open : <?php echo $ti;?>
  </h3>
  </div>
  </div>
  </div>
