...
$result=ins_record("doublepattibid","null,'$userid','$username','$email','$city','Open','$Jodi','$bidnumber','$point1','$date','$time'");
...
$result=ins_record("doublepattibid","null,'$userid','$username','$email','$city','Close','$Jodi','$bidnumber','$point1','$date','$time'");
...
{
if ($cityname==$city." "."Open") {
$result=ins_record("doublepattibid","null,'$userid','$username','$email','$city','Open','$Jodi','$bidnumber1','$point2','$date','$time'");
...
$result=ins_record("doublepattibid","null,'$userid','$username','$email','$city','Close','$Jodi','$bidnumber1','$point2','$date','$time'");
...
$result=ins_record("doublepattibid","null,'$userid','$username','$email','$city','Open','$Jodi','$bidnumber2','$point3','$date','$time'");
$result=ins_record("allbid","null,'$userid','$username','$email','$city','Open','$Jodi','$bidnumber2','$point3','$date','$time'");
$result=ins_record("point2","null,'$userid','$username','Credit','User Bid','$point1','$point3','$time'");
if($result)
{
//echo alrt_msg("Data Insert");
}
...
$result=ins_record("doublepattibid","null,'$userid','$username','$email','$city','Close','$Jodi','$bidnumber2','$point3','$date','$time'");
...
$result=ins_record("doublepattibid","null,'$userid','$username','$email','$city','Open','$Jodi','$bidnumber3','$point4','$date','$time'");
...
$result=ins_record("doublepattibid","null,'$userid','$username','$email','$city','Close','$Jodi','$bidnumber3','$point4','$date','$time'");
...
$result=ins_record("doublepattibid","null,'$userid','$username','$email','$city','Open','$Jodi','$bidnumber4','$point5','$date','$time'");
...
$result=ins_record("doublepattibid","null,'$userid','$username','$email','$city','Close','$Jodi','$bidnumber4','$point5','$date','$time'");
...
$result=ins_record("doublepattibid","null,'$userid','$username','$email','$city','Open','$Jodi','$bidnumber5','$point6','$date','$time'");
...
$result=ins_record("doublepattibid","null,'$userid','$username','$email','$city','Close','$Jodi','$bidnumber5','$point6','$date','$time'");
...
$result=ins_record("doublepattibid","null,'$userid','$username','$email','$city','Open','$Jodi','$bidnumber6','$point7','$date','$time'");
...
$result=ins_record("doublepattibid","null,'$userid','$username','$email','$city','Close','$Jodi','$bidnumber6','$point7','$date','$time'");
...
$result=ins_record("doublepattibid","null,'$userid','$username','$email','$city','Open','$Jodi','$bidnumber7','$point8','$date','$time'");
...
$result=ins_record("doublepattibid","null,'$userid','$username','$email','$city','Close','$Jodi','$bidnumber7','$point8','$date','$time'");
...
$result=ins_record("doublepattibid","null,'$userid','$username','$email','$city','Open','$Jodi','$bidnumber8','$point9','$date','$time'");
...
$result=ins_record("doublepattibid","null,'$userid','$username','$email','$city','Close','$Jodi','$bidnumber8','$point9','$date','$time'");
...
$result=ins_record("doublepattibid","null,'$userid','$username','$email','$city','Open','$Jodi','$bidnumber9','$point10','$date','$time'");
...
$result=ins_record("doublepattibid","null,'$userid','$username','$email','$city','Close','$Jodi','$bidnumber9','$point10','$date','$time'");
  ...
  @media screen and (max-width: 599px) and (min-width: 0px)
{
    ...
    <li class="active"><a data-toggle="pill" href="#home">Double Patti</a></li>
...
$(document).ready(function(){
  ...
  $('#ibtn').click(function(){
    i ++;
    $('#naaa').append('<label for="inputjodi" id="na">Double Patti No.</label><input type="text" class="form-control" id="itex'+i+'" placeholder="Type Double Patti Here." style="margin-bottom: 10px;" name="ham'+i+'">');
