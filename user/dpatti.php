...
<label for="inputjodi" id="na">Double Patti No.</label>
<input type="text" class="form-control" id="itex" name="ham" placeholder="Type Double Patti" style="margin-bottom: 10px;" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
</div>
...
<div class="form-group col-md-6 " id="naaa" style="">
<label for="inputjodi" id="na">Double Patti No.</label>
<input type="text" class="form-control" id="itex" name="ham2" placeholder="Type Double Patti" style="margin-bottom: 10px;" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
</div>
<div class="form-group col-md-6" id="naaaa">
<label for="inputjodiamount" id="na">Bid Amount</label>
<input type="text" class="form-control new" id="itext" name="ha[]" placeholder="Type Bid Amount" style="margin-bottom: 10px;" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
...
<div class="form-group col-md-6 " id="naaa" style="">
<label for="inputjodi" id="na">Double Patti No.</label>
<input type="text" class="form-control" id="itex" name="ham3" placeholder="Type Double Patti" style="margin-bottom: 10px;" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
</div>
<div class="form-group col-md-6" id="naaaa">
<label for="inputjodiamount" id="na">Bid Amount</label>
<input type="text" class="form-control new" id="itext" name="ha[]" placeholder="Type Bid Amount" style="margin-bottom: 10px;" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
